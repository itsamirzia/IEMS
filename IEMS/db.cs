...
namespace IEMS
{
    class db
    {
        public static MySqlConnection MYSQL_connection = new MySqlConnection(ConfigurationManager.AppSettings["conn"].ToString());

        #region        Mysql     Query And Execution

        public static bool SQLQuery(ref DataTable DTCombo, string querystr)
        {
            return SQLQuery(ref DTCombo, querystr, false);
        }
        ...
        public static bool SQLQuery(ref DataTable DTCombo, string querystr, bool Throw_exception)
        {
        ...
        // only for execution
        public static bool ExecuteSQLQuery(string querystr)
        {
            return ExecuteSQLQuery(querystr, false);
        }
        ...
        public static bool ExecuteSQLQuery(string querystr, bool Throw_exception)
        {
            MySqlCommand mMySqlCommand = new MySqlCommand();
